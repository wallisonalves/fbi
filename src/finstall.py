#!/usr/bin/env python
#
# Copyright (c) 2011 Kamil Kajczynski
#
# See COPYING for license terms.
#
# finstall.py v 1.2 Friday, September  2012 12:27:53 Kamil Kajczynski
...
tmp = "/tmp/.fbi"
installer = "/usr/local/etc/fbi/"
query = "sh /usr/local/etc/fbi/backend-query/"
...
class Finstall:
    ...
    # choosing disk part.
        ...
        for line in p.stdout:
            ...
            print ' %s' % line.rstrip()
            print '-----------------------------------'
        DISK = raw_input("\n\n Select a disk to install FreeBSD: ")
    ...
    # Second option slice partition With auto labels.
                ...
                while True:
                    ...
                    if DPART == "d":
                        ...
                        while True:
                            SLICE = raw_input("Select the slice you wish to install FreeBSD to (s1' s2' s3 or s4): ")
    ...
    # Starting the installation.
        call('clear', shell=True)
        FINSTALL = raw_input("Ready To install FreeBSD now?(yes or no): ")
        if FINSTALL == "yes":
            print "install"
